...
Stmt : ';' { Empty } 
  ...
  | Ident '=' Expr ';' { Ass $1 $3 }
  | Ident ListASize '=' Expr ';' { AAss $1 $2 $4 }
  | Ident '++' ';' { Incr $1 }
  | Ident '--' ';' { Decr $1 }
  | 'return' Expr ';' { Ret $2 }
  | 'return' ';' { VRet }
  ...
  | 'for' '(' Type Ident ':' Expr ')' Stmt { Fore $3 $4 $6 $8 }
  | Expr ';' { SExp $1 }
...
Expr6 : Ident { EVar $1 } 
  ...
  | Ident ListASize '.' 'length' { EArrMLen $1 $2 }
  | 'new' Type ListASize { ENArr $2 $3 }
  | Ident ListASize { EIArr $1 $2 }
  | '(' Expr ')' { $2 }
