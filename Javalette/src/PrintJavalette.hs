...
instance Print Stmt where
  prt i e = case e of
   ...
   AAss id asizes expr -> prPrec i 0 (concatD [prt 0 id , prt 0 asizes , doc (showString "=") , prt 0 expr , doc (showString ";")])
   ...
   Fore type' id expr stmt -> prPrec i 0 (concatD [doc (showString "for") , doc (showString "(") , prt 0 type' , prt 0 id , doc (showString ":") , prt 0 expr , doc (showString ")") , prt 0 stmt])
...
instance Print Type where
  prt i e = case e of
   ...
   Arr type' adims -> prPrec i 0 (concatD [prt 0 type' , prt 0 adims])
   Fun type' types -> prPrec i 0 (concatD [prt 0 type' , doc (showString "(") , prt 0 types , doc (showString ")")])
   Str  -> prPrec i 0 (concatD [doc (showString "CANTBECREATED")])
...
instance Print ADim where
  prt i e = case e of
   ArrDim  -> prPrec i 0 (concatD [doc (showString "[") , doc (showString "]")])

  prtList es = case es of
   [x] -> (concatD [prt 0 x])
   x:xs -> (concatD [prt 0 x , prt 0 xs])

instance Print ASize where
  prt i e = case e of
   ArrSize expr -> prPrec i 0 (concatD [doc (showString "[") , prt 0 expr , doc (showString "]")])
...
instance Print Expr where
  prt i e = case e of
   ...
   EArrLen id -> prPrec i 6 (concatD [prt 0 id , doc (showString ".") , doc (showString "length")])
   EArrMLen id asizes -> prPrec i 6 (concatD [prt 0 id , prt 0 asizes , doc (showString ".") , doc (showString "length")])
   ENArr type' asizes -> prPrec i 6 (concatD [doc (showString "new") , prt 0 type' , prt 0 asizes])
   EIArr id asizes -> prPrec i 6 (concatD [prt 0 id , prt 0 asizes])
   ...
   TExpr type' expr -> prPrec i 0 (concatD [prt 0 type' , prt 0 expr])
